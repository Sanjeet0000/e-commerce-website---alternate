    ...
    const itemList = (item) => {
        ...
        return (
            <li className="list-group-item d-flex justify-content-between lh-sm" key={item.id}>
                ...
                <span className="text-muted">${item.discountedPrice}</span>
            </li>
        );
    }
            ...
            <div className="container my-5">
                <div className="row g-5">
                    <div className="col-md-5 col-lg-4 order-md-last">
                        <h4 className="d-flex justify-content-around pb-3">
                            <span className="text-primary">Your cart</span>
                            <span className="badge bg-primary text-light">{state.length}</span>
                        </h4>
                        ...
                        <form className="needs-validation" noValidate="">
                            <div className="row g-3">
                                ...
                                <div className="col-md-6 pt-3">
                                    ...
                                    <select className="form-select ml-1" id="country" required="">
                                ...
                                <div className="col-md-6 pt-3">
                                    ...
                                    <select className="form-select ml-1" id="state" required="">
                                        <option value="">Choose...</option>
